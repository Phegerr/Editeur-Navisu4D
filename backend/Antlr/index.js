...
createServer((req, res) => {
    ...
    var input = "blablabla*bbox,48.0,-5.0,49.0,2.0*move,flyTo,ship,-4.54,48.57,900000.0*layer,oceanography,currents,tidalAtlas,3D,manche,midle*navigation,pilotchart,NAC,3*chart,raster,shom,7311*chart,mbtiles,manche*bbox,48.3,-5.2,48.65,-4.5*layer,bathymetry,litto3D,guadeloupe";
