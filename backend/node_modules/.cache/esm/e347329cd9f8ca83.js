let antlr4;_d9f‍.w("antlr4",[["*",null,function(v){antlr4=v}]]);const express = require('express');
var cors = require('cors');

const { CommonTokenStream, InputStream } = antlr4;

const ScenarioLexer = _d9f‍.i('./Antlr/scenarioLexer.js');
const ScenarioParser = _d9f‍.i('./Antlr/scenarioParser.js');
const HtmlScenarioListener = _d9f‍.i('./Antlr/HtmlScenarioListener.js');
...
app.listen(PORT_EXT, HOST_NAME, function () {
    _d9f‍.g.console.log("Server listen  http://" + HOST_NAME + ":" + PORT_EXT);
});
...
router.route('/scenarios')
    ...
    .post((req, res) => {
        ...
        res.end();
            ...
            _d9f‍.g.console.error(error.message);
            res.write(`Error: ${error.message}`);
            res.end();
            return res; // Arrête l'exécution supplémentaire dans cette requête
        }
