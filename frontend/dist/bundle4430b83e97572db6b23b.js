...
function addquestion() {
  /*
        ...
        */
  var newquestion = '<li id="textArea" > <label for="txtArea" class="labelQuestionTxt">Commentaire et commandes</label><textarea name="commentaireArea" cols="10" rows="1"></textarea></li>';
  document.getElementById("asks").insertAdjacentHTML("beforeend", newquestion);
}
function insertquestion() {
  var insertQuestion = '<li id="textArea" > <label for="txtArea" class="labelQuestionTxt">Commentaire et commandes</label><textarea name="commentaireArea" cols="10" rows="1"></textarea></li>';
...
/* harmony import */ var _js_newScenario_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/newScenario.js */ "./src/js/newScenario.js");
